...
const HEADERS = {
    ...
    'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MGZmNjE3NDY3Mjk2ZTAwMTk5NjQxNDgiLCJpYXQiOjE2MjczNDkzNjR9.RXl7IBspfCgl_O49ryUTUo57QYHpKi6ZQjTXRJSzEJg'
}
...
export const postPoints = async (amount, setRefresh) => {
...
export const postRedeem = async (productId, setRefresh, setOrdersData) => {
